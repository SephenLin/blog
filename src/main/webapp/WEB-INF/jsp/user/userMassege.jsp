...
<article class="page-container">
    <form enctype="multipart/form-data" action="${pageContext.request.contextPath }/user/user-update.action" method="post" class="form form-horizontal" id="creatAccount">
        <div class="row cl">
