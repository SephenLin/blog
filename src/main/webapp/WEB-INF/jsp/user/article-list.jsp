...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" data-title="添加资讯" data-href="${pageContext.request.contextPath }/user/article-addUI.action" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加资讯</a></span> <span class="r">共有数据：<strong id="number">54</strong> 条</span> </div>
    <div class="mt-20">
 ...
 function selectSubmit() {
    ...
    function article_edit(title,id,w,h){
        var index = layer.open({
            type: 2,
            title: title,
            content: "${pageContext.request.contextPath }/user/article-updateUI.action?article_id=" + id,
        });
        layer.full(index);
    }
    /*资讯-删除*/
    ...
    function article_stop(obj,id){
        layer.confirm('确认要下架吗？',function(index){
            ...
            $.ajax({
                type: "get",
                dataType: "json",
                url: '${pageContext.request.contextPath }/user/article-audit.action?id=' + id + "&audit=2" ,
                success: function (data) {
                    if (data.result) {
