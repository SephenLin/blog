...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a data-href="${pageContext.request.contextPath }/user/article-listUI.action" data-title="资讯管理" href="javascript:void(0)">资讯管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-picture">
            ...
            <dd>
                <ul>
                    <li><a data-href="${pageContext.request.contextPath }/image/image-listUI.action" data-title="图片管理" href="javascript:void(0)">图片管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-comments">
            ...
            <dd>
                <ul>
                    ...
                    <li><a data-href="${pageContext.request.contextPath }/user/comment-listUI.action" data-title="评论列表" href="javascript:void(0)">意见反馈</a></li>
                </ul>
            </dd>
        </dl>
        <%--<dl id="menu-system">--%>
            ...
            <%--<dd>--%>
                <%--<ul>--%>
                    <%--<li><a data-href="${pageContext.request.contextPath }/user/system-category.jsp" data-title="栏目管理" href="javascript:void(0)">栏目管理</a></li>--%>
                    <%--<li><a data-href="${pageContext.request.contextPath }/user/system-shielding.jsp" data-title="屏蔽词" href="javascript:void(0)">屏蔽词</a></li>--%>
                <%--</ul>--%>
            <%--</dd>--%>
        <%--</dl>--%>
    </div>
...
<section class="Hui-article-box">
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="${pageContext.request.contextPath }/user/welcome.action"></iframe>
        </div>
    </div>
</section>
...
<script type="text/javascript">
    ...
    function myselfinfo(){
        layer.open({
            ...
            shade:0.4,
            title: '查看信息',
            content: '${pageContext.request.contextPath }/user/user-look.action?id=' + ${loginUser.id},
        });
    }
