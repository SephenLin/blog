...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a data-href="${pageContext.request.contextPath }/admin/article-listUI.action" data-title="资讯管理" href="javascript:void(0)">资讯管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-member">
            ...
            <dd>
                <ul>
                    <li><a data-href="${pageContext.request.contextPath }/admin/user-listUI.action" data-title="用户列表" href="javascript:;">用户列表</a></li>
                    <%--<li><a data-href="${pageContext.request.contextPath }/admin/user-delUI.action" data-title="删除的用户" href="javascript:;">删除的用户</a></li>--%>
                </ul>
            </dd>
        </dl>
        <%--<dl id="menu-system">--%>
            ...
            <%--<dd>--%>
                <%--<ul>--%>
                    <%--<li><a data-href="${pageContext.request.contextPath }/admin/system-articleTypeUI.action" data-title="栏目管理" href="javascript:void(0)">栏目管理</a></li>--%>
                    <%--<li><a data-href="${pageContext.request.contextPath }/admin/system-logUI.action" data-title="系统日志" href="javascript:void(0)">系统日志</a></li>--%>
                <%--</ul>--%>
            <%--</dd>--%>
        <%--</dl>--%>
    </div>
...
<section class="Hui-article-box">
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="${pageContext.request.contextPath }/admin/welcome.action"></iframe>
        </div>
    </div>
</section>
...
<script type="text/javascript">
    ...
    function myselfinfo(){
        layer.open({
            ...
            shade:0.4,
            title: '查看信息',
            content: '${pageContext.request.contextPath }/admin/admin-updateUI.action',
        });
    }
