...
<article class="page-container">
	<form action="${pageContext.request.contextPath }/admin/user-password.action" method="post" class="form form-horizontal" id="form-change-password">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> ${user.account} </div>
		</div>
		<div class="row cl">
