...
<div class="container">
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            ...
            <!-- Start Sign In Form -->
            <form method="post" action="${pageContext.request.contextPath }/userLoginAndRegisterController/login1.action" id="loginUI" class="fh5co-form animate-box" data-animate-effect="fadeInLeft">
                <h2>登录</h2>
                ...
                <div class="form-group">
                    <p>需要返回吗? <a href="${pageContext.request.contextPath }/index.jsp"> 是</a> 或 <a href="#"> 否</a></p>
                </div>
                <div class="form-group">
                    <p>没有账号或忘记密码? <a href="${pageContext.request.contextPath }/register.jsp">注册</a> 或 <a href="${pageContext.request.contextPath }/forgetPassword.jsp">找回密码?</a></p>
                </div>
                <div class="form-group">
...
//手动触发验证
        ...
        if(bootstrapValidator.isValid()){
            $.ajax({
                ...
                dataType: 'json',
                scriptCharset: 'utf-8',
                url: "${pageContext.request.contextPath }/userLoginAndRegisterController/login1.action",
                data: {"account":$("#account").val(),"password":$("#password").val()},
                success: function(data) {
                    if(data.result) {
                        alert(data.message);
                        window.location.href="${pageContext.request.contextPath }/userLoginAndRegisterController/login2.action";//你可以跟换里面的网址，以便成功后跳转
                    }else {
                        alert(data.message);
                    }
                }
